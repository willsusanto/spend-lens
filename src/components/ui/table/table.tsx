...
export const Table = <Entry extends TableEntry>({
  data,
  columns,
  pagination,
}: TableProps<Entry>) => {
  if (!data?.length) {
    return (
      <div className="flex h-80 flex-col items-center justify-center bg-[hsl(var(--surface-lowest))] text-[hsl(var(--on-surface-variant))]">
